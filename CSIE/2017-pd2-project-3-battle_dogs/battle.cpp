...
void Battle::addMinion(const int minionNum,int minionGroup,int minionPosition)
{
    ...
    else if (minionNum == 11)     m = new Saber(scene,minionGroup,minionPosition);
    else if (minionNum == 12)     m = new Nija(scene,minionGroup,minionPosition);
    else if (minionNum == 13)     m = new Robort(scene,minionGroup,minionPosition);
    else if (minionNum == 14)     m = new Shield(scene,minionGroup,minionPosition);
    else if (minionNum == 15)     m = new Ditch(scene,minionGroup,minionPosition);
    else if (minionNum == 16)     m = new Spartan(scene,minionGroup,minionPosition);
    else if (minionNum == 17)     m = new Bigdog(scene,minionGroup,minionPosition);
    else if (minionNum == 18)     m = new Superdog(scene,minionGroup,minionPosition);
    else if (minionNum == 19)     m = new Jesus(scene,minionGroup,minionPosition);
    else if (minionNum == 20)     m = new King(scene,minionGroup,minionPosition);
...
void Battle::battling()
{
        ...
        for (int mini_order = 0; mini_order < minionList[mini_pos].size() ; mini_order++) // QVector<Minion>
        {
            ...
            if (minionList[mini_pos][mini_order].getHP() <= 0)
            {
                if (minionList[mini_pos][mini_order].getGP() == 2) {
                    if (minionList[mini_pos][mini_order].getClass() == 7) money += 80;
                    if (minionList[mini_pos][mini_order].getClass() == 8) money += 100;
                    if (minionList[mini_pos][mini_order].getClass() == 9) money += 300;
                    if (minionList[mini_pos][mini_order].getClass() == 10) money += 200;
                    if (minionList[mini_pos][mini_order].getClass() == 17) money += 200;
                    if (minionList[mini_pos][mini_order].getClass() == 18) money += 300;
                    if (minionList[mini_pos][mini_order].getClass() == 19) money += 400;
                    if (minionList[mini_pos][mini_order].getClass() == 20) money += 500;
                    money += 10;
                }
    ...
    /******************************************* ACTION DONE ***********************************************/
    int aim = Ai->action(time,AI_HP);
    if(aim != 0) addMinion(aim,2,MAXPOSITION-150);
    emit battlingEnd();
}
...
void Battle::totalAttack()
{
    for (int mini_pos = 0; mini_pos <MAXPOSITION; mini_pos++) // MINIONLIST
    {
        ...
        {
            if (minionList[mini_pos][mini_order].getGP() == 2)
                minionList[mini_pos][mini_order].injury(FIRE);
        }
    }
}
